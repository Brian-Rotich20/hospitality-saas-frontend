        ...
        return (
          <Link
            ...
            className={`group flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl
              ...
              ${active
                ? 'bg-[#2D3B45]/5 border border-[#2D3B45]/10'
...
function MobileCategoryGrid({
  ...
  return (
    <section className="px-3 pt-3 pb-2">
      <h2 className="text-xs font-black text-gray-700 mb-2 tracking-wide uppercase">
        Categories
      </h2>
      <div className="grid grid-cols-4 gap-2">
        {categories.map(({ id, name, slug, icon, imageUrl }) => {
          const Icon = (icon && ICON_MAP[icon])
            ? ICON_MAP[icon] : (ICON_MAP[slug] ?? Sparkles);
          ...
          return (
            <Link
              ...
              {/* ✅ Smaller tile — w-14 h-14 fixed instead of aspect-square */}
                ...
                {imageUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center
                    ...
                    <Icon size={20} strokeWidth={1.5}
                      className="text-[#2D3B45]/50 group-hover:text-[#2D3B45] transition-colors" />
                  </div>
                )}
              </div>
              ...
              <span className="text-[10px] font-semibold text-gray-600 text-center
                leading-tight line-clamp-2 w-full group-hover:text-[#2D3B45] transition-colors">
                {name}
              </span>
            </Link>
          );
...
function Store() {
  ...
  // ── Sidebar top: header only, no toolbar offset ───────────────────────────
      ...
      <div className="flex max-w-screen-xl mx-auto">
        ...
        <aside
          ...
          style={{
            ...
            height:    `calc(100vh - ${headerH})`,           // ✅ full remaining height
            overflowY: 'auto',
        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="px-4 lg:px-6 py-4">
            ...
            {showMobileGrid && !loading && listings.length > 0 && (
              <h2 className="text-xs font-black text-gray-700 mb-3 lg:hidden
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-sm font-bold text-gray-700 mb-1">No services found</p>
              ...
              <>
                {/* ✅ This was missing — the actual listings grid */}
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-3">
